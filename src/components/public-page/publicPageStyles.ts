...
export const PUBLIC_SUBPANEL_CLASS =
  "rounded-xl border border-border/70 bg-surface-panel-subtle";
...
export const PUBLIC_EYEBROW_CLASS =
...
export const PUBLIC_BODY_CLASS = "text-sm leading-relaxed text-muted-foreground";

export const PUBLIC_LINK_CLASS =
  "font-semibold text-link underline underline-offset-4 transition-colors hover:text-link-hover";
